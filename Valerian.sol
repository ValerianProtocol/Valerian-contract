...
/* 
Valerian DEFI + NFT protocol on Astar Network
*/

contract VALERIAN is  Context, Ownable  {
    ...
    constructor (address _RouterAddress) public {
        ...
        _symbol = "VAL";
        _decimals = 18;
        _totalSupply = 1e9*1e18; /// initial supply 1000,000,000,000
